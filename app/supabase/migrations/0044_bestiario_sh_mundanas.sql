...
(
  ...
  'Médio', '-2◯+5', '+◯', 12, '+◯+5', '+◯', '-2◯', 6, 3, 'Químico 1',
  '{"agi":1,"for":1,"int":0,"pre":0,"vig":1}', 'Diplomacia +◯+5', '6m | 4',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Soco, corpo a corpo)","teste":"+◯","dano":"1d3+1 impacto"}]',
  80
),
(
  ...
  'Médio', '+2◯+5', '+1◯', 11, '+◯', '+◯', '+2◯+5', 6, 3, null,
  '{"agi":1,"for":1,"int":2,"pre":2,"vig":1}', 'Diplomacia +2◯+5, Profissão (burocrata) +2◯+10', '9m | 6',
...
(
  ...
  'Médio', '+2◯+5', '+◯', 16, '+2◯+5', '+◯', '+2◯+5', 16, 8, null,
  '{"agi":1,"for":2,"int":1,"pre":2,"vig":2}', 'Profissão (fazendeiro) +◯+10', '9m | 6',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Peixeira, corpo a corpo)","teste":"+2◯+5, crítico 19","dano":"1d8+5 corte"},{"tipo":"Padrão","nome":"Agredir (Espingarda, distância curto)","teste":"+◯+5, crítico x3","dano":"4d6 balístico"},{"tipo":"Movimento","nome":"Atiçar os Cães","descricao":"Próximo ataque acertado causa +1d8 dano de perfuração + alvo caído (Luta DT 15 evita)."}]',
  82
),
(
  ...
  'Médio', '+2◯+5', '+2◯+5', 18, '+2◯', '+2◯+5', '+◯+5', 68, 34, null,
  '{"agi":2,"for":1,"int":2,"pre":1,"vig":2}', 'Crime +2◯+5, Diplomacia +◯+5, Furtividade +2◯+5, Intuição +◯+5, Investigação +2◯+5', '9m | 6',
  '[{"nome":"Fonte de Informações","descricao":"Amigável (atitude amistosa/prestativa), 1x/interlúdio dá +5 numa ação de revisar caso."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Soco, corpo a corpo)","teste":"+◯+10","dano":"1d3+1 impacto"},{"tipo":"Padrão","nome":"Agredir (Revólver, distância curto)","teste":"+2◯+10, crítico 19/x3","dano":"2d6+6 balístico"},{"tipo":"Movimento","nome":"Olhar do Investigador","descricao":"Investigação DT 15 num alvo em alcance médio; passando, +1d6 dano contra ele até o fim da cena."}]',
  83
),
(
  ...
  'Médio', '+2◯+5', '+◯', 13, '+◯+5', '+◯', '+2◯+5', 14, 7, null,
  '{"agi":1,"for":1,"int":2,"pre":2,"vig":1}', 'Ciências +2◯+5, Medicina +2◯+10', '9m | 6',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Bisturi, corpo a corpo)","teste":"+2◯+5, crítico 18","dano":"1d4+1 corte"},{"tipo":"Padrão","nome":"Tratar Ferimentos","dano":"Cura 2d10+2 PV","descricao":"Cura si/adjacente; 1x/dia por pessoa."}]',
  84
),
(
  ...
  'Médio', '+3◯+5', '+◯+5', 15, '+◯', '+◯', '+3◯+5', 32, 16, null,
  '{"agi":1,"for":1,"int":2,"pre":3,"vig":1}', 'Diplomacia +3◯+5, Intuição +3◯+5, Religião +3◯+5', '9m | 6',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo)","teste":"+◯+5","dano":"1d3+1 impacto"},{"tipo":"Padrão","nome":"Voz Guia","descricao":"Pessoa em alcance curto que ouça recebe +◯ no próximo teste de perícia até o fim da próxima rodada."},{"tipo":"Padrão","nome":"Voz Acusadora","dano":"3d6 mental + alquebrado (Vontade DT 15 reduz à metade e evita)","descricao":"Alvo em alcance curto."},{"tipo":"Reação","nome":"Sacrifício Sagrado","descricao":"1x/rodada, ao sofrer dano, troca de lugar com seguidor adjacente que sofre o dano no lugar."}]',
  85
),
(
  ...
  'Médio', '+3◯+10', '+3◯+5', 21, '+◯+5', '+3◯+10', '+3◯+10', 60, 30, null,
  '{"agi":3,"for":3,"int":2,"pre":3,"vig":1}', 'Diplomacia +3◯+10, Enganação +3◯+10, Intimidação +3◯+10', '9m | 6',
  '[{"nome":"Escondido em Plena Vista","descricao":"Em ambientes movimentados, usa Enganação no lugar de Furtividade, sem penalidade/redução de deslocamento por ações chamativas em furtividade."},{"nome":"Recursos Abundantes","descricao":"Acessa locais/documentos restritos, comete crimes menores sem punição; crimes graves podem ter um \"bode expiatório\" (a critério do mestre)."},{"nome":"Sorriso Sedutor","descricao":"Quem não sabe que é assassino fica desprevenido contra ele, -◯ em testes contra ele."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Navalha, corpo a corpo x2)","teste":"+3◯+10, crítico 19/x3","dano":"1d8+13 corte"},{"tipo":"Padrão","nome":"Agredir (Machado, corpo a corpo x2)","teste":"+3◯+10, crítico x3","dano":"2d8+13 corte"},{"tipo":"Padrão","nome":"Agredir (Pistola Silenciada, distância x2 curto)","teste":"+3◯+10, crítico x3","dano":"1d12+13 balístico"},{"tipo":"Livre","nome":"Ataque Furtivo","descricao":"1x/rodada, +3d6 dano contra desprevenido/flanqueado (corpo a corpo ou distância curta)."},{"tipo":"Padrão","nome":"Guarda-Costas","descricao":"1x/cena, chama 1d4+1 capangas que chegam na próxima rodada."}]',
  86
),
(
  ...
  'Médio', '+◯+5', '+2◯+10', 23, '+3◯+10', '+2◯+10', '+◯+5', 80, 40, null,
  '{"agi":2,"for":3,"int":1,"pre":1,"vig":3}', 'Atletismo +3◯+10, Sobrevivência +◯+10', '9m | 6',
  '[{"nome":"Abrutalhado","descricao":"Usa itens de duas mãos com uma só, usa objetos de criatura Grande sem penalidade; resistência a dano 10/paranormal enquanto machucado."},{"nome":"Área de Caça","descricao":"+◯ em perícia na área onde caça (definida pelo mestre)."},{"nome":"Faro para Humanos","descricao":"+2◯ em Sobrevivência envolvendo pessoas; percebe humanos por faro."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo x2)","teste":"3◯+15","dano":"1d4+15 impacto"},{"tipo":"Padrão","nome":"Agredir (Machado, corpo a corpo x2)","teste":"3◯+15, crítico x3","dano":"2d8+15 corte"},{"tipo":"Padrão","nome":"Agredir (Motosserra, corpo a corpo x2)","teste":"3◯+15, crítico x4","dano":"3d6+15 corte"},{"tipo":"Livre","nome":"Ataque Furtivo","descricao":"1x/rodada, +4d6 dano contra desprevenido/flanqueado."},{"tipo":"Movimento","nome":"Imparável","descricao":"Anula qualquer redução de deslocamento (outras consequências do efeito continuam)."},{"tipo":"Padrão","nome":"Assustar","dano":"4d6 mental (Vontade DT 20 reduz à metade)","descricao":"Em quem vê/ouve em alcance curto."},{"tipo":"Padrão","nome":"Fatalidade","descricao":"1 ataque de pancada; acertando, também causa ferimento debilitante; 1x/cena por alvo."}]',
  87
),
(
  ...
  'Médio', '+3◯+15', '+3◯+15', 27, '+◯+5', '+3◯+15', '+3◯+15', 150, 75, null,
  '{"agi":3,"for":1,"int":3,"pre":3,"vig":1}', 'Artes +3◯+15, Enganação +3◯+15, Furtividade +3◯+15', '9m | 6',
  '[{"nome":"Matar É Uma Arte","descricao":"Usa Artes no lugar de qualquer perícia envolvendo mentes/corpos humanos (necropsia, persuadir); com horas pra analisar cena/vítima, substitui Investigação por Artes com +◯."},{"nome":"Cenas Imprevisíveis","descricao":"Se quis disfarçar como acidente, DT pra achar pistas na cena +5; se quis deixar sua marca, quem vê a cena e não sai imediatamente fica enjoado + 4d8 dano mental (Vontade DT 25 reduz à metade e evita)."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Bisturi, corpo a corpo x2)","teste":"3◯+15, crítico 19/x4","dano":"1d4+17 corte"},{"tipo":"Livre","nome":"Ataque Furtivo","descricao":"1x/rodada, +7d6 dano contra desprevenido/flanqueado."},{"tipo":"Padrão","nome":"Discurso Artístico","dano":"4d8 mental + alquebrado e frustrado (Vontade DT 25 reduz à metade e evita frustrado)","descricao":"Todos em alcance curto que ouvem; 1x/cena por pessoa."}]',
  88
),
(
  ...
  'Médio', '+◯+5 (Faro, Visão na Penumbra)', '+2◯+5', 16, '+2◯', '+2◯+5', '+◯', 32, 16, null,
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Mordida, corpo a corpo)","teste":"2◯+5","dano":"2d4+2 corte"}]',
  89
),
(
  ...
  'Grande', '+◯+5 (Faro, Visão na Penumbra)', '+◯+5', 13, '+2◯', '+◯+5', '+◯', 12, 6, null,
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Cascos, corpo a corpo)","teste":"3◯+5","dano":"2d4+3 impacto"}]',
  90
),
(
...
(
  ...
  'Grande', '+◯+5 (Faro, Visão na Penumbra)', '+2◯+5', 19, '+3◯+5', '+2◯+5', '+◯', 70, 35, null,
  '{"agi":2,"for":3,"int":0,"pre":1,"vig":3}', 'Atletismo +3◯+5', '9m | 6, Escalar 9m | 6',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo x2)","teste":"2◯+10","dano":"1d6+3 impacto"},{"tipo":"Livre","nome":"Morder","teste":"2◯+10","dano":"1d6+4 corte","descricao":"Acertando as 2 pancadas no mesmo alvo, ataca também com mordida."}]',
  92
),
(
  ...
  'Grande', '+◯+10 (Faro, Visão na Penumbra)', '+3◯+10', 18, '+2◯+5', '+3◯+10', '+2◯+5', 80, 40, null,
  '{"agi":3,"for":3,"int":0,"pre":2,"vig":2}', 'Atletismo +3◯+10, Furtividade +3◯+8', '15m | 10',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Garras, corpo a corpo x2)","teste":"3◯+10, crítico 19","dano":"1d6+4 corte"},{"tipo":"Padrão","nome":"Agredir (Mordida, corpo a corpo)","teste":"3◯+10","dano":"1d8+4 corte"},{"tipo":"Livre","nome":"Agarrão","teste":"3◯+12","descricao":"Ao acertar mordida em alvo Médio ou menor, tenta agarrar."},{"tipo":"Completa","nome":"Bote","descricao":"Investida + ataca com mordida e as 2 garras (3 ataques, todos com bônus de investida) contra o mesmo alvo."}]',
  93
),
(
  ...
  'Médio', '+◯+5 (Faro, Visão na Penumbra)', '+3◯+5', 15, '+2◯+5', '+3◯+5', '+◯', 18, 9, null,
  '{"agi":3,"for":3,"int":0,"pre":1,"vig":2}', 'Sobrevivência +◯+10', '12m | 8',
  '[{"nome":"Táticas de Alcateia","descricao":"Flanqueando, +◯ adicional no ataque (total +2◯ com o bônus normal de flanquear) + 1d6 dano extra na mordida."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Mordida, corpo a corpo)","teste":"3◯+5","dano":"1d6+4 corte"},{"tipo":"Livre","nome":"Derrubar","teste":"3◯+5","descricao":"Acertando mordida, manobra de derrubar."}]',
  94
),
(
  ...
  'Grande', '+◯+5 (Faro, Visão na Penumbra)', '+◯', 15, '+2◯+5', '+◯', '+◯', 38, 19, null,
  '{"agi":1,"for":3,"int":0,"pre":1,"vig":2}', null, '12m | 8',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Chifres, corpo a corpo)","teste":"3◯+5","dano":"2d6+6 perfuração"},{"tipo":"Completa","nome":"Atropelamento (recarga: movimento)","dano":"2d6+6 impacto + caído (Reflexos DT 15 reduz à metade e evita)","descricao":"Percorre o dobro do deslocamento em linha reta, atravessando espaços de seres menores; quem está na linha sofre o efeito."}]',
  95
),
(
  ...
  'Grande', '+◯+5 (Faro, Visão na Penumbra)', '+◯+5', 19, '+3◯+10', '+◯+5', '+2◯', 90, 45, 'Balístico, corte, impacto e perfuração 2',
  '{"agi":1,"for":3,"int":0,"pre":2,"vig":3}', 'Atletismo +3◯+10', '12m | 8',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Garras, corpo a corpo x2)","teste":"3◯+10, crítico 19","dano":"1d6+4 corte"},{"tipo":"Padrão","nome":"Agredir (Mordida, corpo a corpo)","teste":"3◯+10","dano":"1d8+4 corte"},{"tipo":"Livre","nome":"Agarrão","teste":"3◯+12","descricao":"Ao acertar mordida em alvo Médio ou menor, tenta agarrar."}]',
  96
);
