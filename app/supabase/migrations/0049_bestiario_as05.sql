...
(
  ...
  'Pessoa infectada por um Interflorado — sangue vira plasma verde, dificuldade com cores, pisca um olho por vez. Expelir o parasita sem sofrer dano exige choque térmico forte (aquecer + água gelada); aí "afloroa" e vira um Hospedeiro Aflorado. 4 variantes possíveis: Acólito (INT/PRE 2, Ocultismo/Percepção/Religião/Vontade 2◯+5, conjura 2 rituais de 1º círculo grátis até 3 PE, DT 15); Faz-Tudo (+1 em 2 atributos, +5 em 4 perícias escolhidas, 1 perícia rola 2x e fica com o melhor resultado); Guerrilheiro (AGI/FOR/VIG 2, PV 20/10, Atletismo/Fortitude/Iniciativa/Reflexos 2◯+5, pancada 2◯+10/1d4+10, pistola 2◯+10/1d12+10); Socorrista (INT/PRE 2, Medicina/Percepção/Vontade 2◯+5, 1x/cena cura 1d8+1 PV).',
  '{Energia,Conhecimento}', 'Médio', null, null, null, '+◯+5', '+◯+5', 15, '+◯+5', '+◯+5', '+◯+5', 10, 5, null, null,
  ...
  '[{"tipo":"Padrão","nome":"Pancada, corpo a corpo","teste":"◯+5","dano":"1d4+5 impacto"}]',
  150
),
(
  ...
  '{Energia,Conhecimento}', 'Médio', 19, '3d6 mental', 35, '2◯ (Percepção às Cegas, Visão no Escuro)', '2◯+5', 25, '3◯+10', '2◯+5', '2◯', 100, 50, 'Balístico, corte, impacto e perfuração 5, Conhecimento/Energia/químico 10', 'Fogo, frio e Sangue',
  '{"agi":2,"for":2,"int":1,"pre":2,"vig":3}', null, '9m | 6',
  '[]',
  '[{"tipo":"Padrão","nome":"Pancada, corpo a corpo x2","teste":"2◯+10","dano":"1d6+5 impacto + 2d6 químico"},{"tipo":"Movimento","nome":"Disparada Errante","descricao":"2x deslocamento, Acrobacia DT 20 ou cai."},{"tipo":"Padrão","nome":"Guinchou Gutural","dano":"5d10 (metade Conhecimento/metade Energia)","descricao":"9m raio; tapar ouvidos = metade dano + surdo 1 rodada; não tapar = dano cheio + surdo 1d4+1 rodadas."}]',
  151
),
(
  ...
  '{Energia,Conhecimento}', 'Pequeno', 15, '2d8 mental', 30, '+◯+5 (Visão no Escuro)', '2◯+5', 19, '+0', '2◯+5', '+◯+5', 70, 35, 'Balístico, corte, impacto e perfuração 5, Conhecimento/Energia/químico 10', 'Fogo, frio e Sangue',
  '{"agi":2,"for":2,"int":1,"pre":1,"vig":null}', 'Acrobacia/Atletismo 2◯+5, Furtividade 2◯+10', null,
  '[]',
  '[{"tipo":"Movimento","nome":"Contorcer Perturbador","dano":"2d8 mental + apavorado + trêmulo (Vontade DT 15 reduz à metade/evita, mas fica abalado)","descricao":"Imune 1 dia se passar."},{"tipo":"Padrão","nome":"Guincho Gutural","descricao":"Igual ao do Aflorado."},{"tipo":"Completa","nome":"Incubar","descricao":"Após 1 dia num hospedeiro, 1x/dia, incuba 1 ovo (máx 2d4/hospedeiro, -1d6 Sanidade máx permanente por ovo); estourar mata o hospedeiro, gera novos interflorados."},{"tipo":"Completa","nome":"Investida Sufocante","teste":"2◯+10","descricao":"2x deslocamento + agarrar; vitorioso deixa o alvo agarrado/cego/surdo/asfixiado; inconsciente = vira Hospedeiro Parasitado."}]',
  152
),
(
  (select id from sources where slug = 'arquivos_secretos_05'), 'paranormal', 'Fummu', 100,
  'Criatura de Transmissão dos Alheios.',
  '{Energia,Conhecimento}', 'Médio', 21, '4d6 mental', 45, '2◯+5 (Visão no Escuro)', '3◯+10', 25, '2◯', '3◯+10', '2◯+5', 200, 100, 'Balístico, corte, impacto e perfuração 10, Conhecimento/Energia/químico 20; imune a fogo', 'Sangue',
  '{"agi":3,"for":2,"int":2,"pre":2,"vig":2}', 'Atletismo 2◯+10, Furtividade 3◯+10', null,
  '[{"nome":"Camuflagem Alheia","descricao":"Invisível, +15 Furtividade vs. ouvir, quem não vê fica desprevenido; +2◯ ataques vs. não-cegos (cegos -5 Defesa); perde invisibilidade em gás/fumaça (fica camuflagem leve)."},{"nome":"Chamas Ferventes","descricao":"Quem agarra sofre 2d10 fogo/rodada."}]',
  '[{"tipo":"Padrão","nome":"Toque Ácido, corpo a corpo x2","teste":"3◯+15","dano":"2d10+10 químico"},{"tipo":"Movimento","nome":"Cintilação Estelar","descricao":"1x/rodada se não agarrado, teleporta 9m."},{"tipo":"Padrão","nome":"Acionar Explosão","dano":"Minúsculo = 2d6 fogo + chamas raio 3m, +2d6/+1,5m por categoria de tamanho acima","descricao":"Combustão de objeto inflamável em alcance médio."},{"tipo":"Padrão","nome":"Chama Viridente","dano":"4d10+20 fogo + chamas (Reflexos DT 21 reduz à metade/evita)","descricao":"1 ser em alcance médio."}]',
  153
),
(
  ...
  '{Energia,Conhecimento}', 'Médio', null, null, null, '2◯+5', '+0', 14, null, null, null, 14, 7, null, null,
  '{"agi":1,"for":1,"int":3,"pre":2,"vig":1}', null, null,
  '[{"nome":"Disfarce Alheio","descricao":"Enganação: rola 2x e fica com o melhor resultado."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo)","teste":"◯+5","dano":"1d4+2 impacto"},{"tipo":"Padrão","nome":"Agredir (Pistola Plasma, distância)","teste":"◯+5, crítico 18","dano":"2d6+2 Energia"}]',
  154
),
(
  ...
  '{Energia,Conhecimento}', 'Médio', null, null, null, '2◯+5', '2◯+5', 19, null, null, null, 70, 35, null, null,
  '{"agi":2,"for":2,"int":3,"pre":2,"vig":1}', null, null,
  '[{"nome":"Close Quarter Combat","descricao":"+◯ ataque corpo a corpo e manobras; mira/recarrega/saca como ação livre."},{"nome":"Especialista em Manobras","descricao":"Agarrar/derrubar/desarmar como ação livre (Teste 2◯+12)."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo x2)","teste":"2◯+10","dano":"1d10+5 impacto"},{"tipo":"Padrão","nome":"Agredir (Pistola, distância x2)","teste":"2◯+10, crítico 18","dano":"2d6+5 Energia"},{"tipo":"Reação","nome":"Proteger","descricao":"Vira alvo no lugar de aliado adjacente."}]',
  155
),
(
  ...
  '{Energia,Conhecimento}', 'Médio', null, null, null, '4◯+10', '3◯+10', 28, null, null, null, 240, 120, null, null,
...
(
  ...
  '{Energia,Conhecimento}', 'Médio', 15, '1d4 mental', 30, '3◯+10', '3◯+10', 12, null, null, null, 42, 21, 'Balístico, corte, impacto e perfuração 5, Conhecimento/Energia/químico 10', 'Sangue',
  '{"agi":3,"for":2,"int":3,"pre":4,"vig":2}', 'Artes, Ciências, Furtividade, Ocultismo, Religião e Tecnologia 3◯+10', null,
  '[]',
...
(
  ...
  'Criatura de Transmissão dos Alheios.',
  '{Energia,Conhecimento}', 'Médio', 24, '4d8 mental', 70, '3◯+10', '2◯+5', 31, null, null, null, 200, 100, 'Balístico, corte, impacto e perfuração 10, Conhecimento/Energia/fogo/químico 20; imune a gases', 'Sangue',
