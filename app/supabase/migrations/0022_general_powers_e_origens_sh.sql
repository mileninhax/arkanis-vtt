...
from (values
  ...
  ('Foco em Perícia', 'Escolhe uma perícia (exceto Luta/Pontaria); +1d20 nela; pode escolher de novo pra perícias diferentes.', 'Treinado na perícia'),
  ...
  ('Mentiroso Nato', 'Treina (ou +2) Enganação; penalidade por mentiras implausíveis cai pra -1d20.', 'Pre 2'),
