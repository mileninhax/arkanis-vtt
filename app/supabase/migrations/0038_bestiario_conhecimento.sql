...
(
  ...
  '{Conhecimento}', 'Enorme', 40, '10d6 mental', null, '+25 (5d20, Percepção às Cegas)', '+25 (4d20)', 57, '+25 (5d20)', '+25 (4d20)', '+30 (5d20)', 1111, 555, 'Dano 50', 'Sangue',
...
(
  ...
  '{Conhecimento}', 'Grande', 35, '7d8 mental', 90, '+20 (5d20, Percepção às Cegas)', '+20 (5d20)', 41, '+15 (4d20)', '+25 (5d20)', '+20 (5d20)', 750, 375, 'Balístico, corte, impacto e Conhecimento 20', 'Sangue',
  '{"agi":5,"for":4,"int":3,"pre":5,"vig":4}', 'Atletismo +15 (4d20), Furtividade +18 (5d20)', '15m | 10',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Garras Atormentadoras, corpo a corpo x3)","teste":"+35 (5d20)","dano":"4d10+10 Conhecimento"},{"tipo":"Movimento","nome":"Atormentar","dano":"3d8 mental, +3d8 se escondido (Vontade DT 30 reduz à metade)","descricao":"Sussurros num alvo em alcance curto."},{"tipo":"Completa","nome":"Saltar e Assustar","dano":"10d8 mental (Vontade DT 35 reduz à metade)","descricao":"Se escondido de um alvo em alcance curto, sai do esconderijo assumindo forma assustadora."}]',
  null, 25
),
(
  ...
  '{Conhecimento}', 'Médio', 30, '7d6 mental', 70, '+15 (3d20, Percepção às Cegas)', '+15 (4d20)', 34, '+10 (2d20)', '+15 (4d20)', '+15 (3d20)', 500, 250, null, 'Sangue',
  '{"agi":4,"for":2,"int":3,"pre":3,"vig":2}', 'Furtividade +20 (4d20)', '12m | 8',
  '[{"nome":"Imunidades","descricao":"Dano."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo x2)","teste":"+10 (2d20)","dano":"1d6+2 impacto"},{"tipo":"Movimento","nome":"Correr pelas Frestas","descricao":"Teletransporta-se pra qualquer espaço em alcance longo, desde que haja uma fresta (espaço Pequeno ou menor delimitado por objeto/superfície) no caminho."},{"tipo":"Completa","nome":"Espreitar","dano":"10d6 mental (Vontade DT 30 reduz à metade)","descricao":"1x/cena, adjacente a um ser dormindo; se a vítima enlouquecer com esse dano, pode criar uma Cópia Observada dela."},{"tipo":"Padrão","nome":"Cópia Observada","descricao":"Manifesta uma cópia de alguém deixado enlouquecendo por Espreitar — usa a mesma ficha, mas causa dano de Conhecimento em vez do normal, não conjura rituais/habilidades paranormais, dura até o fim da cena."}]',
...
(
  ...
  '{Conhecimento}', 'Médio', 14, '1d6 mental', 25, '+5 (2d20, Percepção às Cegas)', '+5 (1d20)', 13, '+0 (2d20)', '+0 (1d20)', '+10 (2d20)', 36, 18, 'Balístico, corte e impacto 5, Conhecimento 10', 'Sangue',
  '{"agi":1,"for":1,"int":4,"pre":2,"vig":2}', 'Ciências +10 (4d20), Ocultismo +10 (4d20)', '9m | 6',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo)","teste":"+5 (1d20)","dano":"1d4+1 impacto"},{"tipo":"Livre","nome":"Brilho Enlouquecedor","dano":"1d6 mental (Vontade DT 14 reduz à metade)","descricao":"1x/rodada, marcas douradas brilham; todos em alcance médio que o veem."},{"tipo":"Movimento","nome":"Fortalecimento Paranormal","descricao":"Até o fim da cena, +1d20 em testes de Agilidade/Força/Vigor e +2d4 dano de Conhecimento nas pancadas; só usável se já causou dano mental com Brilho Enlouquecedor nesta cena."}]',
  null, 28
),
(
  ...
  '{Conhecimento}', 'Médio', 20, '4d6 mental', 45, '+10 (2d20, Percepção às Cegas)', '+10 (2d20)', 22, '+5 (2d20)', '+0 (2d20)', '+10 (2d20)', 180, 90, 'Balístico, corte e impacto 10, Conhecimento 20', 'Sangue',
  '{"agi":2,"for":2,"int":4,"pre":2,"vig":2}', 'Ciências +10 (4d20), Ocultismo +10 (4d20)', '9m | 6',
  '[{"nome":"Aura Manifestada","descricao":"Cercado por uma aura dourada de faces flutuantes que gritam; quem está em alcance curto sofre -2d20 em todos os testes."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Pancada, corpo a corpo x2)","teste":"+5 (2d20)","dano":"2d4+7 impacto"},{"tipo":"Padrão","nome":"Expandir Aura","dano":"6d6 mental (Vontade DT 20 reduz à metade)","descricao":"Quem está em alcance curto."}]',
  null, 29
),
(
  ...
  '{Conhecimento}', 'Grande', 35, '8d6 mental', 80, '+15 (5d20, Percepção às Cegas)', '+0', 37, '+15 (3d20)', '+0', '+20 (5d20)', 390, 195, 'Balístico, corte, impacto e Conhecimento 20', 'Sangue',
...
(
  ...
  '{Conhecimento,Sangue,Morte}', 'Médio', 20, '2d6 mental', 35, '+0 (4d20, Percepção às Cegas)', '+0 (2d20)', 15, '+10 (1d20)', '+10 (2d20)', '+10 (4d20)', 90, 45, null, null,
...
(
  ...
  '{Conhecimento,Sangue}', 'Médio', 25, '6d6 mental', 60, '+15 (3d20, Percepção às Cegas)', '+15 (4d20)', 41, '+15 (3d20)', '+15 (4d20)', '+10 (3d20)', 330, 165, 'Balístico, corte e impacto 10, Conhecimento 20', 'Sangue',
  '{"agi":4,"for":3,"int":3,"pre":3,"vig":3}', 'Furtividade +15 (4d20), Ocultismo +15 (3d20)', '12m | 8',
...
(
  ...
  '{Conhecimento}', 'Médio', 40, '8d8 mental', null, '+25 (5d20, Percepção às Cegas)', '+20 (4d20)', 55, '+20 (4d20)', '+20 (4d20)', '+25 (5d20)', 500, 250, 'Dano 30', 'Sangue',
...
(
  ...
  '{Conhecimento}', 'Médio', 15, '3d6 mental', 30, '+5 (2d20, Percepção às Cegas)', '+5 (4d20)', 19, '+0', '+5 (4d20)', '+5 (2d20)', 60, 30, 'Balístico, corte e perfuração 5, Conhecimento 10', 'Sangue',
  '{"agi":4,"for":2,"int":2,"pre":2,"vig":1}', 'Furtividade +10 (4d20)', '12m | 8',
  '[{"nome":"Aura Tangível","descricao":"Ataques contra alguém sob condição de medo causam +2d6 dano de Conhecimento."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Toque Macabro, corpo a corpo x2)","teste":"+10 (4d20)","dano":"2d6 Conhecimento"},{"tipo":"Completa","nome":"Plantar Paranoia","descricao":"Chacoalha a Membrana; todos em alcance médio ficam abalados (Vontade DT 15 evita; já abalado vira apavorado); -1d20 no teste se o vulto estiver escondido ao usar."}]',
  null, 34
),
(
  ...
  '{Conhecimento}', 'Minúsculo', 45, '10d8 mental', null, '+35 (6d20, Percepção às Cegas)', '+25 (4d20)', 55, '+35 (5d20)', '+25 (4d20)', '+35 (6d20)', 1200, 600, null, 'Sangue',
  '{"agi":4,"for":4,"int":6,"pre":6,"vig":5}', 'Ciência +35 (6d20), Ocultismo +35 (6d20), Religião +35 (6d20)', 'Voo 12m | 8',
