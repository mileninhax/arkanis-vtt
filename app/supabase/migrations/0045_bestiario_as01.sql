...
(
  ...
  'Médio', '+2◯+10', '+3◯+5', 23, '+2◯+10', '+◯+5', '+2◯+10', 90, 45, null,
  '{"agi":1,"for":3,"int":2,"pre":2,"vig":2}', 'Atletismo +3◯+10, Intimidação +2◯+10, Ocultismo +2◯+10', '9m | 6',
  '[{"nome":"Rituais (DT 20)","descricao":"Conjura sem pagar PE, até 6 PE por conjuração."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Cutelo, corpo a corpo x2)","teste":"4◯+15, crítico x3","dano":"1d6+15 corte"},{"tipo":"Padrão","nome":"Ritual Armadura de Sangue Discente (Sangue 1)","descricao":"+10 Defesa + resistência a balístico/corte/impacto/perfuração 5 até o fim da cena."},{"tipo":"Padrão","nome":"Ritual Descarnar Discente (Sangue 2)","dano":"10d8 (metade corte/metade Sangue) + hemorragia (Fortitude DT 20 reduz à metade e evita; hemorragia = 4d8 Sangue por turno até passar 2 testes de Fortitude seguidos)","descricao":"Toque."},{"tipo":"Padrão","nome":"Ritual Esfolar Discente (Sangue 1)","dano":"5d4+5 corte + sangrando (Reflexos DT 20 reduz à metade e evita)","descricao":"Explosão 6m raio, alcance médio."},{"tipo":"Padrão","nome":"Ritual Transfusão Vital (Sangue 2)","descricao":"Perde até 50 PV, toca aliado que recupera o mesmo tanto."}]',
  98
),
(
  ...
  'Médio', '+3◯+15 (Percepção às Cegas)', '+2◯+10', 30, '+3◯+15', '+2◯+10', '+3◯+15', 300, 150, null,
  '{"agi":2,"for":4,"int":2,"pre":3,"vig":3}', 'Atletismo +4◯+15, Intimidação +3◯+15, Ocultismo +2◯+15', '9m | 6',
...
(
  ...
  'Médio', '+3◯+10', '+2◯+5', 23, '+◯+5', '+2◯+5', '+3◯+10', 70, 35, null,
  '{"agi":2,"for":1,"int":4,"pre":3,"vig":1}', 'Crime +2◯+10, Enganação +3◯+10, Furtividade +2◯+10, Ocultismo +4◯+10', '9m | 6',
  '[{"nome":"Rituais (DT 20)","descricao":"Conjura sem pagar PE, até 6 PE por conjuração."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Revólver, distância curto)","teste":"2◯+5, crítico 19","dano":"2d6+10 balístico"},{"tipo":"Padrão","nome":"Agredir (Faca, corpo a corpo)","teste":"2◯+5, crítico 19","dano":"1d4+10 perfuração"},{"tipo":"Padrão","nome":"Ritual Distorcer Aparência (Sangue 1)","descricao":"Muda aparência própria/de outro em alcance curto até o fim da cena; +10 Enganação pra disfarce; resistir/identificar exige Vontade DT 20."},{"tipo":"Padrão","nome":"Ritual Esconder dos Olhos (Conhecimento 2)","descricao":"Invisível (camuflagem total + 15 Furtividade); termina se atacar ou usar habilidade hostil."},{"tipo":"Padrão","nome":"Ritual Espelho (Sangue+Conhecimento 2)","descricao":"Cria cópia de carne/sangue de si mesmo ou de ser já visto (mesmas estatísticas); controla e percebe através dela; fica atordoado enquanto concentrado; identificar exige Intuição/Ocultismo/Percepção/Vontade DT 20."},{"tipo":"Padrão","nome":"Ritual Fortalecimento Sensorial Discente (Sangue 1)","descricao":"+◯ em Investigação/Luta/Percepção/Pontaria até o fim da cena; inimigos -◯ pra atacá-lo."},{"tipo":"Padrão","nome":"Ritual Terceiro Olho (Conhecimento 1)","descricao":"Vê auras paranormais em alcance longo por 1 dia; ação de movimento identifica poderes paranormais/rituais de alguém em alcance médio."}]',
  100
),
(
  ...
  'Médio', '+0', '+2◯+5', 20, '+3◯+10', '+◯+5', '+0', 100, 50, null,
  '{"agi":1,"for":4,"int":1,"pre":1,"vig":3}', 'Atletismo +4◯+10', '9m | 6',
...
(
  ...
  'Médio', '+◯+5', '+3◯+10', 21, '+2◯+5', '+3◯+10', '+0', 80, 40, null,
  '{"agi":3,"for":2,"int":1,"pre":1,"vig":2}', 'Acrobacia +3◯+10, Atletismo +2◯+10', '9m | 6',
  ...
  '[{"tipo":"Padrão","nome":"Agredir (Arpão do Pescador, distância curto)","teste":"3◯+10, crítico x3","dano":"1d6+10 perfuração +1d6 Sangue"},{"tipo":"Padrão","nome":"Agredir (Faca, corpo a corpo x2)","teste":"3◯+10, crítico 19","dano":"1d4+10 perfuração"},{"tipo":"Padrão","nome":"Engolir Metal","descricao":"Engole objeto metálico Pequeno ou menor; perde 1d6 PV, +2 em testes de Força/Agilidade (cumulativo, até 3 itens)."}]',
  102
),
(
  ...
  'Médio', '+2◯+5', '+2◯+10', 18, '+0', '+2◯+10', '+2◯+5', 70, 35, null,
  '{"agi":2,"for":1,"int":2,"pre":2,"vig":1}', 'Atletismo +◯+10, Enganação +2◯+10', '9m | 6',
  '[{"nome":"Sangue Maldito","descricao":"Munição banhada em seu sangue causa +1d6 dano de Sangue (uma única vez)."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Soco com Pregos, corpo a corpo x2)","teste":"◯+10","dano":"1d4+10 impacto"},{"tipo":"Padrão","nome":"Agredir (Pregador Pneumático, distância x2 curto)","teste":"2◯+10, crítico x4","dano":"3d4+10 perfuração +1d6 Sangue"},{"tipo":"Completa","nome":"Pregos de Sangue","descricao":"Remove pregos do corpo e recarrega o pregador, aplicando Sangue Maldito."}]',
  103
),
(
...
(
  ...
  'Médio', '+2◯+5', '+2◯+10', 20, '+2◯+5', '+2◯+5', '+2◯+10', 80, 40, null,
  '{"agi":2,"for":2,"int":2,"pre":2,"vig":2}', 'Atletismo +2◯+5, Crime +2◯+5, Intuição +2◯+10, Investigação +2◯+10, Tática +2◯+5', '9m | 6',
  '[]',
  '[{"tipo":"Padrão","nome":"Agredir (Pistola, distância x2 curto)","teste":"2◯+10, crítico 18","dano":"1d12+10 balístico"},{"tipo":"Padrão","nome":"Agredir (Pé de Cabra, corpo a corpo x2)","teste":"2◯+10","dano":"1d8+10 impacto"},{"tipo":"Reação","nome":"Durona","descricao":"1x/cena, dano que reduziria a 0 PV a deixa em 1 PV (não funciona com dano massivo)."},{"tipo":"Completa","nome":"Empurrar e Atirar","descricao":"Empurra alvo 3m com o pé de cabra (Fortitude DT 20 evita) + atira; empurrando com sucesso, +◯ no ataque e +1d12 dano se acertar."}]',
  105
),
(
...
(
  ...
  '{Sangue,Conhecimento}', 'Médio', 20, '4d6 mental', 45, '◯+10', '2◯+10, Visão no Escuro', 25, '3◯+10', '2◯+5', '◯+10', 190, 95, 'Balístico, impacto e perfuração 5, Conhecimento e Sangue 10', 'Morte',
  '{"agi":2,"for":3,"int":1,"pre":1,"vig":3}', '9m | 6',
  '[{"nome":"Corpo Oscilante","descricao":"Na 1ª vez que alguém olha diretamente pra ele, sofre 2d6 dano mental; qualquer ação visando o Anulado conta como \"olhar diretamente\" (evitar isso dá -◯ nos testes contra ele, mas evita o dano)."},{"nome":"Golpes Anulados","descricao":"Distribui os ataques entre até 3 alvos diferentes."},{"nome":"Quero o Seu Corpo","descricao":"Ao errar um ataque contra ele, testa Reflexos DT 25 ou fica agarrado; começando o turno agarrando alguém, suga órgãos: 4d10 dano de Sangue, recupera metade do dano em PV."}]',
  '[{"tipo":"Padrão","nome":"Agredir (Braços Grotescos, corpo a corpo x2)","teste":"3◯+15","dano":"1d8+10 impacto"},{"tipo":"Padrão","nome":"Agredir (Mordida Asquerosa, corpo a corpo)","teste":"3◯+15","dano":"1d10+10 Sangue"}]',
  107
);
